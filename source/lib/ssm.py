...
class SSM(object):
    ...
    def put_parameter(self, name, value, description="This value was stored by Serverless Transit Network Orchestrator Solution.",
    ...
    def put_parameter_use_cmk(self, name, value, key_id, description="This value was stored by Serverless Transit Network Orchestrator Solution.",
    ...
    def delete_parameter(self, name):
        try:
            ...
            if e.response['Error']['Code'] == 'ParameterNotFound':
                self.logger.info("Caught exception 'ParameterNotFound', the key was already deleted or never created.")
                return {}
            else:
                message = {'FILE': __file__.split('/')[-1], 'CLASS': self.__class__.__name__,
                           'METHOD': inspect.stack()[0][3], 'EXCEPTION': str(e)}
