...
import os
import pytest
from tgw_peering.lib.tgw_peering_helper import validate_tag, tag_event_router
from tgw_peering.lib.utils import TGWPeer
...
class TestTagEventRouter:
    ...
    def test__success(self, mocker):
        ...
        m1 = mocker.patch(
            "tgw_peering.lib.transit_gateway.TGWPeering.delete_tgw_peering_attachment"
        )
        mocker.patch(
            "tgw_peering.lib.transit_gateway.TGWPeering.get_tgw_peers",
            side_effect=[
                [],
        ...
        m2 = mocker.patch(
            "tgw_peering.lib.transit_gateway.TGWPeering.create_tgw_peering_attachment",
        )
        m3 = mocker.patch(
            "tgw_peering.lib.transit_gateway.TGWPeering.accept_tgw_peering_attachment",
        )
