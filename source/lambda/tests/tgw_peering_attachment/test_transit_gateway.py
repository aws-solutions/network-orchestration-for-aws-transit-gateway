...
from solution.tgw_peering_attachment.lib.transit_gateway import TGWPeering
from solution.tgw_peering_attachment.lib.utils import TGWPeer, AttachmentState
...
class TestAcceptPeeringAttachment:
    ...
    def test__success(self, mocker):
        ...
        mocker.patch(
            "solution.tgw_peering_attachment.lib.transit_gateway.TGWPeering.tgw_attachment_waiter",
