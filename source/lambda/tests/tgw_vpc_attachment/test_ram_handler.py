...
def mock_ram(mocker, elements: List[ResourceShareInvitationTypeDef]):
    ...
    mocker.patch("solution.tgw_vpc_attachment.lib.clients.ram.RAM.get_resource_share_invitations", mock_get_invitations)

    def mock_accept_invitations(self, arn):
        return {}

    mocker.patch("solution.tgw_vpc_attachment.lib.clients.ram.RAM.accept_resource_share_invitation", mock_accept_invitations)
...
def test_ram_accept_resource_share_invitation_in_org_non_china_region():
    # ARRANGE
    override_environment_variables()
...
def test_ram_accept_resource_share_invitation_in_org_china_region():
    # ARRANGE
    override_environment_variables()
    os.environ['PARTITION'] = 'aws-cn'
    os.environ['FIRST_PRINCIPAL'] = 'arn:aws-cn:organizations'
