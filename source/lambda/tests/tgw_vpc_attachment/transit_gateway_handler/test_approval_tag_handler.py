...
@mock_sts
def test_tgw_route_approval_required_tag_conditional_with_rule_in_ou__rule_matched_1(
        vpc_setup_with_explicit_route_table):
    # ARRANGE
    override_environment_variables()
    os.environ['TGW_ID'] = vpc_setup_with_explicit_route_table['tgw_id']
...
@mock_sts
def test_tgw_route_approval_required_tag_conditional_with_rule_not_in_ou__rule_matched_2(
        vpc_setup_with_explicit_route_table):
    # ARRANGE
    override_environment_variables()
    os.environ['TGW_ID'] = vpc_setup_with_explicit_route_table['tgw_id']
...
@mock_sts
def test_tgw_route_approval_required_tag_conditional_with_rule_not_in_ou__rule_does_not_match_1(
        vpc_setup_with_explicit_route_table):
    # ARRANGE
    override_environment_variables()
    os.environ['TGW_ID'] = vpc_setup_with_explicit_route_table['tgw_id']
...
@mock_sts
def test_tgw_route_approval_required_tag_conditional_with_rule_not_in_ou__rule_does_not_match_2(
        vpc_setup_with_explicit_route_table):
    # ARRANGE
    override_environment_variables()
    os.environ['TGW_ID'] = vpc_setup_with_explicit_route_table['tgw_id']
...
@mock_sts
def test_tgw_route_approval_required_tag_conditional_with_rule_not_in_ou__rule_does_not_match_3(
        vpc_setup_with_explicit_route_table):
    # ARRANGE
    override_environment_variables()
    os.environ['TGW_ID'] = vpc_setup_with_explicit_route_table['tgw_id']
