...
def mock_ram(mocker, elements: List[ResourceShareInvitationTypeDef]):
    ...
    mocker.patch("tgw_vpc_attachment.lib.clients.ram.RAM.get_resource_share_invitations", mock_get_invitations)

    def mock_accept_invitations(self, arn):
        return {}

    mocker.patch("tgw_vpc_attachment.lib.clients.ram.RAM.accept_resource_share_invitation", mock_accept_invitations)
