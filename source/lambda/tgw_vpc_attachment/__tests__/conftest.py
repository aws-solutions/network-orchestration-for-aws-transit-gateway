...
def override_environment_variables():
    ...
    os.environ['ROUTING_TAG'] = 'Route-to-tgw'
    os.environ['PROPAGATION_TAG'] = 'Propagate-to'
    os.environ['APPROVAL_KEY'] = 'ApprovalRequired'
    os.environ['LOG_GROUP_ACTIONS'] = 'Actions'
    os.environ['LOG_GROUP_FAILURES'] = 'Failures'
    os.environ["DEFAULT_ROUTE"] = '0.0.0.0/0'
    os.environ["ALL_TRAFFIC"] = '0.0.0.0/0'
...
@pytest.fixture
def vpc_setup_with_explicit_route_table(ec2_client: EC2Client):
    ...
    subnet_route_table_association = ec2_client.associate_route_table(
    ...
    yield {
        ...
        'tgw_vpc_attachment_state': tgw_vpc_attachment['State'],
        'route_table_id': route_table['RouteTableId'],
        'transit_gateway_route_table': gateway_route_table['TransitGatewayRouteTableId'],
        'subnet_route_table_association': subnet_route_table_association['AssociationId'],
    }
...
def vpc_setup_no_explicit_route_table(ec2_client: EC2Client):
    ...
    assert main_route_table["VpcId"] == vpc['VpcId']
